...
def print_board(board: list) -> str:
    ...
    part1, part2 = board[12:18], board[18:24]  # w kolejności printowania
    part3, part4 = board[11:5:-1], board[5::-1]  # w kolejności printowania, odwrócone
...
def play_game(agent):
    ...
    while not done:
        dice_roll = env.roll_dice()
        print(f"Rzut kośćmi: {dice_roll}")
        print(print_board(env.board))  # Wyświetlenie planszy
        ...
        if player == 'white':
            ...
            # 🔥 Sprawdzamy, czy biały ma pionki na barze
            if env.bar['white'] > 0:
                possible_moves = [0]  # Gracz musi ruszyć pionka z baru
            else:
                possible_moves = [i for i, value in enumerate(env.board) if value > 0]  # Normalne ruchy
            ...
            print(print_board(env.board))  # Wyświetl planszę po ruchu
            ...
            print(print_board(env.board))  # Wyświetl planszę po drugim ruchu
            # possible_moves = [i for i, value in enumerate(env.board) if value > 0]
            ...
            if env.bar['black'] > 0:
                possible_moves = [23]  # Bot musi zdjąć pionek z baru
            else:
                possible_moves = [i for i, value in enumerate(env.board) if value < 0]
            ...
            while not success1 and not success2:
                ...
                print(print_board(env.board))  # Wyświetl planszę po ruchu 1
                possible_moves = [i for i, value in enumerate(env.board) if value < 0]
